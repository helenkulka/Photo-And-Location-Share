//
//  LocationSharePhotoController.swift
//  PhotoAndLocationShare
//
//  Created by Helen Kulka on 8/23/19.
...
class LocationSharePhotoController: UIViewController {
    ...
    var locationName: String? {
        didSet {
            self.locationPicked.text = locationName
        }
    }
